...
@section('content')
    <div class="overflow-x-auto">
        <div class="card shadow-xl">
            ...
            <div class="card-body">
                <form action="/jenis_ujian/{{ $item->kode_jenis_ujian }}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="jenis_ujian" type="text" placeholder="Type here"
                            value="{{ old('jenis_ujian', $item->jenis_ujian) }}"
